...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-10">
        <section class="bg-white p-8 rounded-xl shadow-md max-w-lg w-full text-center">
            <h1 class="text-2xl font-bold text-gray-800">Administrar Estancia de Huéspedes</h1>
            <p class="text-gray-600 mt-4">En esta sección se administrarán las estancias de los huéspedes.</p>
        </section>
    </main>
</body>
</html>
